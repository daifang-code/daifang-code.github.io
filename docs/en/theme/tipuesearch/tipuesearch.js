                         ...
                         if (standard)
                         {
                              ...
                              for (var i = 0; i < tipuesearch.pages.length; i++)
                              {
                                   ...
                                   for (var f = 0; f < d_w.length; f++)
                                   {
                                        ...
                                        if (tipuesearch.pages[i].title.toLowerCase().search(new RegExp(d_w[f].toLocaleLowerCase())) != -1)
                                        {
                                             score += 15;
                                        }
                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   if (l_o >= start && l_o < set.show + start)
                                   {
                                        ...
                                        out += '<div class="tipue_search_content_title">'+ (i + 1) + '. ' +'<a href="' + found[i].url + '"' + tipue_search_w + '>' +  found[i].title + '</a></div>';
